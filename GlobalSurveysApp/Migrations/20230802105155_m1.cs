        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateMobile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    placeOfBirth = table.Column<int>(type: "int", nullable: false),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CertificateLevel = table.Column<int>(type: "int", nullable: false),
                    FieldOfStudy = table.Column<int>(type: "int", nullable: false),
                    PassportNumber = table.Column<int>(type: "int", nullable: false),
                    Gender = table.Column<int>(type: "int", nullable: false),
                    FirstContractDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    IdCard = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Users_DirectResponsibleId",
                        column: x => x.DirectResponsibleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_DirectResponsibleId",
                table: "Users",
                column: "DirectResponsibleId");
